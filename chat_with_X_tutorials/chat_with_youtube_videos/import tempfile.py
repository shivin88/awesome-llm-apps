...
# Set API Key
genai.configure(api_key="AIzaSyA8SiOVTffZhAIk-13m_7jBo55FZsZg7c0")
...
def generate_response(query: str, relevant_chunks: List[str], llm) -> str:
    try:
        ...
        *Final Answer:*  
        ...
        response = llm.generate_content(prompt)  # Use llm instead of model
...
def main():
    ...
    if prompt:
        ...
        answer = generate_response(prompt, relevant_chunks, llm)  # Pass llm
        print("\nAnswer:", answer)
